...
//   function() {
//     let gameOverFlg = isSelect(a_1); // gameStatusを返却 fukada
//     if (counter < 9 && gameEnd === "0") bearTurn(); //fukada
//   }, false
// );
// // 上記のコーディングと下記のコーディングは同じ意味
// a_2.addEventListener("click", () => {
//   let gameOverFlg = isSelect(a_2);  // gameStatusを返却 fukada
//   if (counter < 9 && gameEnd === "0") bearTurn(); //fukada
// });
...
squaresArray.forEach(function (square) {
  square.addEventListener('click', function () {
    ...
    if (counter < 9 && gameOverFlg === "0") bearTurn(); //fukada
  });
});
